...
public class Product {
    ...
    private final ProductId id; // Bu ozel bir yapi mi? Yoksa sadece deger mi?
    private String name;
    private String description;
    private Money money;
    private Integer stock;

    //final -> sdece uretilirken alinir sonrasindan alinmaz.ProductId de bir kere uretilsin saglam olsun.

    //Kontrollu Üretim-> Ctor'i private yapiyoruz.
    //Bu nesne yalnizca benim verecegim fabrika metotlari ile olusturulsun.
